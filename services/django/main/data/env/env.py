...
DJANGO_SECRET_KEY = (
    read_secret("ALEXPASSALIS_DJANGO_SECRET_KEY")
    if IS_RUNTIME
...
POSTGRES_URL = (
    read_secret("ALEXPASSALIS_POSTGRES_URL")
    if IS_RUNTIME
    else "postgresql://test:test@172.17.0.4:5432/test"  # validate_env("ALEXPASSALIS_POSTGRES_URL") NEEDS FIXING
)
